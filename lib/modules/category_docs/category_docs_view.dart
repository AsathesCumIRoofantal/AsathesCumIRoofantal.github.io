...
const _slate = Color(0xFF263238);
const _lime = Color(0xFF84CC16);
const _amber = Color(0xFFF59E0B);
const _ink = Color(0xFF111418);

class CategoryDocsView {
  final bool isEmbedded;
  final bool isDark;
  const CategoryDocsView({this.isEmbedded = false, required this.isDark});
...
Widget _split(String t) => Row(
  children: [
    Expanded(child: Container(height: 1, color: _slate.withValues(alpha: 0.3))),
    Padding(
