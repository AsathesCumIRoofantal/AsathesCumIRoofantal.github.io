...
/// Learn Docs — alifiyas (beginner) lane.
/// Common requisites first, then role-shaped specifics.
class NewAppLearnDocsView extends GetView<NewAppLearnDocsController> {
  const NewAppLearnDocsView({super.key});

  static const Color _c1 = Color(0xFF0D47A1);
