...
/// Auto-generated unique themed wrapper for Entities.
/// Adds a fresh design + new content sections while preserving original content
/// (the original EntitiesView is embedded below the new sections).
///
/// Theme: Aurora Teal | Layout: wave
class EntitiesEnhancedView extends StatelessWidget {
  const EntitiesEnhancedView({Key? key}) : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Aurora Teal', layout: 'wave',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.insights_outlined, title: 'Entities'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                title: 'Action Steps',
                child: Column(children: [
                  _Step(n: 1, text: 'Set a 10-minute timer of presence', accent: _accent, gold: _gold),
                  _Step(n: 2, text: 'Notice five things you can sense', accent: _accent, gold: _gold),
                  _Step(n: 3, text: 'Release one expectation', accent: _accent, gold: _gold),
                  _Step(n: 4, text: 'Receive whatever arrives', accent: _accent, gold: _gold),
                ]),
              ),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Quote(text: 'What we plant in the soil of contemplation, we shall reap in the harvest of action.', author: 'Meister Eckhart',
