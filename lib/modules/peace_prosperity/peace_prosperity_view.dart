...
class PeaceProsperityView extends GetView<PeaceProsperityController> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFF031A0A), const Color(0xFF020D05)],
        ...
        boxShadow: [
          BoxShadow(color: _sage.withValues(alpha: 0.12), blurRadius: 18),
        ],
      ),
      child: Column(
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Monitor community-level wellbeing through peace and prosperity indicators that go beyond GDP — surfacing the human signals that define a truly thriving community.',
                      style: TextStyle(
                        fontSize: 12,
                        height: 1.4,
  ...
  Widget _buildScorecard(BuildContext context, bool isDark, Color onSurface) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _sage.withValues(alpha: 0.14)),
      ),
      child: Column(
        children: indicators
            .map(
  ...
  Widget _buildPeaceQuote(BuildContext context, bool isDark, Color onSurface) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [_sage.withValues(alpha: 0.10), _sky.withValues(alpha: 0.07)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(16),
