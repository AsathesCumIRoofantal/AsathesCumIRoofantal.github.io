...
class ObligationsView extends GetView<ObligationsController> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFF020830), const Color(0xFF010418)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(22),
        border: Border.all(color: _law.withValues(alpha: 0.38)),
        boxShadow: [
          BoxShadow(color: _blue.withValues(alpha: 0.12), blurRadius: 18),
        ],
      ),
      child: Column(
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: _law.withValues(alpha: 0.15),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Track every legal, moral, and contractual commitment so nothing slips through the cracks. AIR surfaces due dates, counterparties, and breach risks in one accountable view.',
                      style: TextStyle(
                        fontSize: 12,
                        height: 1.4,
  ...
  Widget _buildDashboard(BuildContext context, bool isDark, Color onSurface) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _law.withValues(alpha: 0.14)),
      ),
      child: Column(
  ...
  Widget _buildObligationsQuote(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [_law.withValues(alpha: 0.10), _teal.withValues(alpha: 0.07)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: _law.withValues(alpha: 0.20)),
      ),
      child: Row(
        children: [
