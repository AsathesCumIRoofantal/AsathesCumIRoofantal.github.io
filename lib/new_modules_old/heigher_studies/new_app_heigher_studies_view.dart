...
/// Higher Studies — alifiyas (beginner) lane.
/// Common requisites first, then role-shaped specifics.
class NewAppHeigherStudiesView extends GetView<NewAppHeigherStudiesController> {
  const NewAppHeigherStudiesView({super.key});

  static const Color _c1 = Color(0xFF4A148C);
  static const Color _c2 = Color(0xFFAB47BC);
