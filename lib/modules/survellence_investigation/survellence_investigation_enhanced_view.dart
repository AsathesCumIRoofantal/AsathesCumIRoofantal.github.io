      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Survellence Investigation',
                style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.w800, color: Colors.white)),
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Royal Plum', layout: 'circles',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.lightbulb_outlined, title: 'Survellence Investigation'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
