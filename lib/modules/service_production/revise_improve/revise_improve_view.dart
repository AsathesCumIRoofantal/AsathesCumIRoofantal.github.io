    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFF061A06), const Color(0xFF030C03)],
        ...
        boxShadow: [
          BoxShadow(color: _green.withValues(alpha: 0.10), blurRadius: 16),
        ],
      ),
      child: Column(
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Inspect completed outputs, gather structured feedback, and tighten the next processing cycle with targeted refinements. Continuous improvement is a disciplined habit, not a one-off project.',
                      style: TextStyle(
                        fontSize: 12,
                        height: 1.4,
  ...
  Widget _buildBacklogItems(
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _lime.withValues(alpha: 0.14)),
      ),
      child: Column(
