  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    bottomNavigationBar: Obx(
      () => NavigationBar(
        ...
        destinations: DashboardView._navItems
            .map(
                    ...
                    () => Row(
                      children: [
                        ...
                        Expanded(
                          child: _StatCard(
                            label: 'Unread',
                            value: ctrl.unreadMessages.value,
                        ...
                        Expanded(
                          child: _StatCard(
                            label: 'Live',
                            value: ctrl.activeMeetings.value,
                        ...
                        Expanded(
                          child: _StatCard(
                            label: 'Online',
                            value: ctrl.onlineDevices.value,
                  ...
                  child: Column(
                    ...
                    children: [
                      _SectionTitle(
                        'Upcoming Meetings',
                        onSeeAll: () =>
                            Get.find<DashboardController>().navigate(2),
                      ),
                      SizedBox(height: 12.h),
                      Obx(
                        () => ctrl.upcomingMeetings.isEmpty
                            ? _EmptyState(
                                icon: Icons.videocam_off_rounded,
                                label: 'No meetings scheduled',
                              )
                            : Column(
                                children: ctrl.upcomingMeetings
                                    .map(
                                      (m) => _MeetingMiniCard(
                                        meeting: m,
                                        theme: theme,
                  ...
                  child: Column(
                    ...
                    children: [
                      _SectionTitle(
                        'Recent Chats',
                        onSeeAll: () =>
                            Get.find<DashboardController>().navigate(1),
                      ),
                      SizedBox(height: 12.h),
                      Obx(
                        () => ctrl.recentChats.isEmpty
                            ? _EmptyState(
                                icon: Icons.chat_bubble_outline_rounded,
                                label: 'No chats yet',
                              )
                            : Column(
                                children: ctrl.recentChats
                                    .take(4)
                                    .map(
                                      (r) =>
                                          _ChatMiniTile(room: r, theme: theme),
                                    )
                                    .toList(),
                              ),
                      ),
