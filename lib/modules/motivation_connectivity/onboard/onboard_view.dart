    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFF0E0440), const Color(0xFF07021F)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(22),
        border: Border.all(color: _launch.withValues(alpha: 0.38)),
        boxShadow: [
          BoxShadow(color: _launch.withValues(alpha: 0.14), blurRadius: 18),
        ],
      ),
      child: Column(
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: _launch.withValues(alpha: 0.15),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'A great onboarding experience is the fastest way to convert a newcomer into a confident, contributing member of AIR. Let\'s get you fully oriented.',
                      style: TextStyle(
                        fontSize: 12,
                        height: 1.4,
              ...
              FractionallySizedBox(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: _launch.withValues(alpha: 0.4),
                        blurRadius: 6,
                      ),
                    ],
                  ),
  ...
  Widget _buildOnboardQuote(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: _launch.withValues(alpha: 0.20)),
      ),
      child: Row(
        children: [
