    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFF02061C), const Color(0xFF010310)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(22),
        border: Border.all(color: _earth.withValues(alpha: 0.38)),
        boxShadow: [
          BoxShadow(color: _earth.withValues(alpha: 0.14), blurRadius: 18),
        ],
      ),
      child: Column(
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: _earth.withValues(alpha: 0.15),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Maintain a clear-eyed view of global context — regions, active crises, and emerging opportunities at planetary scale — so you are never blindsided by macro shifts.',
                      style: TextStyle(
                        fontSize: 12,
                        height: 1.4,
          ...
          .map(
            (r) => Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: r.$3.withValues(alpha: 0.18)),
              ),
              child: Row(
                children: [
                  const Icon(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: r.$3.withValues(alpha: 0.14),
  ...
  Widget _buildWorldQuote(BuildContext context, bool isDark, Color onSurface) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: _earth.withValues(alpha: 0.20)),
      ),
      child: Row(
        children: [
