...
class CountingReportsScreen extends StatefulWidget {
  const CountingReportsScreen({super.key});

  @override
  State<CountingReportsScreen> createState() => _CountingReportsScreenState();
}

class _CountingReportsScreenState extends State<CountingReportsScreen>
