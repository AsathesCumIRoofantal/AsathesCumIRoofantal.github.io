...
class SurvellenceInvestigationView extends GetView<SurvellenceInvestigationController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('SurvellenceInvestigation'),
        elevation: 0,
      ...
      body: Container(
        ...
        child: SafeArea(
          child: Center(
            child: Text('SurvellenceInvestigation is working'),
          ),
        ),
      ),
    );
