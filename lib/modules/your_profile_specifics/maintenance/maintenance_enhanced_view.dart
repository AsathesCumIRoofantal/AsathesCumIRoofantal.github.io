...
class MaintenanceEnhancedView extends StatelessWidget {
  const MaintenanceEnhancedView({Key? key}) : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Olive Grove', layout: 'circles',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.emoji_objects_outlined, title: 'Maintenance'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
