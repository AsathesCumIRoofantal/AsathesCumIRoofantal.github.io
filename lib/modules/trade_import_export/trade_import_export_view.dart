...
class TradeImportExportView extends GetView<TradeImportExportController> {
  const TradeImportExportView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return SampleContentPage(
      title: 'Trade Import Export',
      subtitle: 'Explore placeholder content for Trade Import Export in AIR.',
      icon: Icons.article_outlined,
      items: const [
        SampleContentItem(
          title: 'Overview',
          subtitle: 'Learn about how Trade Import Export works inside AIR.',
