...
class KeepAddingWithPatienceEnhancedView extends StatelessWidget {
  const KeepAddingWithPatienceEnhancedView({Key? key}) : super(key: key);
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Keep Adding With Patience',
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Clay Earth', layout: 'grid',
                ...
                icon: Icons.auto_awesome_outlined, title: 'Keep Adding With Patience'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
