...
class _LearnDocsBodyState extends State<_LearnDocsBody>
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Structured reading rooms. Pair with Learn & Fun for deep study rhythm.',
                            style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...[
                    (
                      'Sliver lazy loading',
                      'Thousands of docs load instantly with SliverList.builder',
                    ),
                    (
                      'Adaptive search',
                      'Debounced search with GetX reactivity — zero rebuilds',
                    ),
                    (
                      'AI doc summaries',
                      'ML-powered reading time estimates and key highlights',
                    ),
                    (
                      'Offline-first cache',
                      'IndexedDB + Hive sync for reading without internet',
                    ),
                  ].map(
                    (e) => Padding(
