...
/// Learn And Fun — alifiyas (beginner) lane.
/// Common requisites first, then role-shaped specifics.
class NewAppLearnFunView extends GetView<NewAppLearnFunController> {
  const NewAppLearnFunView({super.key});

  static const Color _c1 = Color(0xFF1B5E20);
  static const Color _c2 = Color(0xFF66BB6A);
