...
class EntertainmentEnhancedView extends StatelessWidget {
  const EntertainmentEnhancedView({Key? key}) : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Slate Steel', layout: 'stripes',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.rocket_launch_outlined, title: 'Entertainment'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
