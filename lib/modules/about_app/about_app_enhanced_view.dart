...
/// Auto-generated unique themed wrapper for About App.
...
class AboutAppEnhancedView extends StatelessWidget {
  const AboutAppEnhancedView({Key? key}) : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Magenta Pulse', layout: 'diagonal',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.spa_outlined, title: 'About App'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
          ...
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Quote(text: 'The wound is the place where the Light enters you.', author: 'Rumi',
