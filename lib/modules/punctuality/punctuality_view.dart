...
class PunctualityView extends GetView<PunctualityController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('PUNCTUALITY', style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.bold, fontSize: 14)),
        centerTitle: true,
        actions: [Padding(padding: const EdgeInsets.only(right: 16),
          child: Icon(Icons.schedule_outlined, color: _blue, size: 22))],
      ),
      body: ListView(
        ...
        children: [
          ...
          _buildSectionLabel('TIME INTEGRITY SCORE', Icons.timer_outlined, _blue, onSurface),
          const SizedBox(height: 12),
          _buildScorePanel(context, isDark, onSurface),
          const SizedBox(height: 24),
          _buildSectionLabel('TIME INTEGRITY TOOLS', Icons.build_rounded, _sky, onSurface),
          const SizedBox(height: 12),
          _buildCard(context, isDark, Icons.timer_outlined, _blue, 'Time SLAs',
          ...
          _buildCard(context, isDark, Icons.hourglass_bottom_outlined, _amber, 'Buffer Planning',
          ...
          const SizedBox(height: 10),
          _buildCard(context, isDark, Icons.people_outline, _teal, 'Respect for Others\' Time',
          ...
          const SizedBox(height: 10),
          _buildCard(context, isDark, Icons.event_available_outlined, _green, 'Deadline Integrity',
          ...
          const SizedBox(height: 10),
          _buildCard(context, isDark, Icons.notifications_active_outlined, _red, 'Early Warning System',
          ...
          const SizedBox(height: 10),
          _buildCard(context, isDark, Icons.bar_chart_outlined, _blue, 'Time Audit',
          ...
          const SizedBox(height: 10),
          _buildCard(context, isDark, Icons.alarm_outlined, _sky, 'Clock Discipline',
  ...
  Widget _buildHeroHeader(BuildContext context, bool isDark, Color onSurface) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [const Color(0xFF050B20), const Color(0xFF020610)],
            begin: Alignment.topLeft, end: Alignment.bottomRight),
        borderRadius: BorderRadius.circular(22),
        border: Border.all(color: _blue.withOpacity(0.35)),
        boxShadow: [BoxShadow(color: _blue.withOpacity(0.10), blurRadius: 16)],
      ),
      child: Column(children: [
        Row(children: [
          Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(
            color: _blue.withOpacity(0.15), borderRadius: BorderRadius.circular(14)),
            child: const Icon(Icons.schedule_outlined, color: _sky, size: 28)),
          const SizedBox(width: 14),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Text('TIME INTEGRITY', style: TextStyle(fontSize: 10, color: _sky, fontWeight: FontWeight.bold, letterSpacing: 2)),
            const SizedBox(height: 4),
            const Text('Punctuality in AIR is time integrity — treating your commitments to others\' time as seriously as you treat your own. Being on time is a form of respect made visible.',
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Stack(children: [
            ...
            FractionallySizedBox(widthFactor: m.$2, child: Container(height: 5, decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: m.$3.withOpacity(0.30), blurRadius: 4)],
            ))),
          ]),
        ]),
      )).toList()),
  ...
  Widget _buildPunctualityQuote(BuildContext context, bool isDark, Color onSurface) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [_blue.withOpacity(0.10), _teal.withOpacity(0.07)],
            begin: Alignment.topLeft, end: Alignment.bottomRight),
        borderRadius: BorderRadius.circular(16),
