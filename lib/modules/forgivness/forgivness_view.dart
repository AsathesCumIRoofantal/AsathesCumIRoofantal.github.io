...
class ForgivnessView extends GetView<ForgivnessController> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFF14043A), const Color(0xFF0A021C)],
        ...
        boxShadow: [
          BoxShadow(color: _purple.withValues(alpha: 0.12), blurRadius: 16),
        ],
      ),
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Forgiveness is a practice of release — letting go of the grip a past harm has on your present decisions — not pretending the harm never happened.',
                  style: TextStyle(
                    fontSize: 12,
                    height: 1.4,
  ...
  Widget _buildClarityPanel(
    ...
    final checks = [
      ...
      (
        'IS choosing not to let harm define what comes next',
        Icons.check_rounded,
        _green,
      ),
  ...
  Widget _buildForgivenessQuote(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: _lavender.withValues(alpha: 0.20)),
      ),
      child: Row(
        children: [
