...
class FollowCalendarEnhancedView extends StatelessWidget {
  const FollowCalendarEnhancedView({Key? key}) : super(key: key);
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Follow Calendar',
                style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.w800, color: Colors.white)),
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Glacier Blue', layout: 'blocks',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.brightness_5_outlined, title: 'Follow Calendar'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
