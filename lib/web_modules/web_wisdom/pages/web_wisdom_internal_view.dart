          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: GlowBackground(
                colors: [section.primary, section.primary.withValues(alpha: .55), const Color(0xFF2A1450)],
                child: Center(
                  child: WMaxWidth(
                    child: Column(
                      ...
                      children: [
                        Reveal(
                          child: Text('A QUIET READING ROOM',
                              style: TextStyle(
                                  letterSpacing: 4,
                        ...
                        Reveal(
                          delayMs: 120,
                          child: Text('Wisdom, in three movements.',
                              style: TextStyle(
                                  color: Colors.white,
              ...
              child: VisibilityDetectorStub(
                ...
                child: WMaxWidth(
                  ...
                  child: Reveal(
                    delayMs: 60,
                    child: _ChapterBlock(
                        chapter: ch, accent: section.primary, ink: ink),
                  ),
                ),
              ),
            );
            ...
            child: WMaxWidth(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: section.primary.withValues(alpha: .25)),
                ),
...
class _ChapterBlock extends StatelessWidget {
  ...
  const _ChapterBlock({required this.chapter, required this.accent, required this.ink});
  @override
  Widget build(BuildContext context) {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(colors: [accent, accent.withValues(alpha: .6)]),
            ),
            child: Center(child: Text(chapter.roman, style: const TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.w900))),
          ),
    ...
    final right = Column(
      ...
      children: [
        Text(chapter.title,
            style: TextStyle(
                color: ink, fontSize: mobile ? 28 : 40,
        ...
        Wrap(spacing: 10, runSpacing: 10, children: [
          for (final tag in ['practice', 'reflect', 'apply'])
            Container(
              ...
              child: Text(tag, style: TextStyle(color: accent, fontWeight: FontWeight.w700)),
            ),
        ]),
      ],
    );
    return mobile
        ...
        : Row(crossAxisAlignment: CrossAxisAlignment.start, children: [left, const SizedBox(width: 32), Expanded(child: right)]);
  }
}

class _ChapterRail extends SliverPersistentHeaderDelegate {
  final WebWisdomInternalController controller;
  final List<_Chapter> chapters;
  final Color accent, bg, ink;
  _ChapterRail({required this.controller, required this.chapters, required this.accent, required this.bg, required this.ink});
  @override
                ...
                for (var i = 0; i < chapters.length; i++) ...[
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: controller.currentPage.value == i ? accent : accent.withValues(alpha: .12),
                        borderRadius: BorderRadius.circular(99),
                      ),
                      child: Row(children: [
                        Text(chapters[i].roman,
                            style: TextStyle(
                                color: controller.currentPage.value == i ? Colors.white : accent,
                                fontWeight: FontWeight.w800)),
                        const SizedBox(width: 8),
                        Text(chapters[i].title,
                            style: TextStyle(
                                color: controller.currentPage.value == i ? Colors.white : ink,
                                fontWeight: FontWeight.w600)),
                      ]),
                    ),
                  ),
...
class VisibilityDetectorStub extends StatefulWidget {
  ...
  const VisibilityDetectorStub({super.key, required this.child, required this.onVisible});
  @override
