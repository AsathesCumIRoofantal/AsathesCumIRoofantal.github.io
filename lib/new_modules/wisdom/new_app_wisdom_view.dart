...
/// Wisdom — alifiyas (beginner) lane.
/// Common requisites first, then role-shaped specifics.
class NewAppWisdomView extends GetView<NewAppWisdomController> {
  const NewAppWisdomView({super.key});

  static const Color _c1 = Color(0xFF3E2723);
  static const Color _c2 = Color(0xFFA1887F);
