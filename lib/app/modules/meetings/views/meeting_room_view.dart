...
class MeetingRoomView extends StatelessWidget {
  ...
  // ── Waiting Room ─────────────────────────────────────
  Widget _buildWaitingRoom(MeetingRoomController ctrl, ThemeData theme) =>
      Center(
        child: Column(
        ...
        if (Responsive.isDesktop(ctx))
          Positioned(
            ...
            child: Obx(() {
              ...
              if (ctrl.isParticipantPanelOpen.value)
                return _ParticipantSidePanel(ctrl: ctrl);
...
class _ParticipantGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Obx(() {
    ...
    return GridView.builder(
      ...
      itemBuilder: (_, i) =>
          _ParticipantTile(participant: parts[i], ctrl: ctrl),
    );
  });
}
...
class _SpotlightLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Obx(() {
    final active =
        ctrl.participants.firstWhereOrNull(
    ...
    child: Row(
      children: [
        ...
        IconButton(
          ...
          onPressed: () => ctrl.setLayout(
            ctrl.layoutMode.value == 'grid' ? 'spotlight' : 'grid',
          ),
        ),
      ],
    ),
...
class _MeetingControls extends StatelessWidget {
      ...
      () => Row(
        ...
        children: [
          ...
          _CtrlBtn(
            ...
            label: 'Share',
            color: ctrl.isScreenSharing.value ? Colors.green : Colors.white70,
          ...
          _CtrlBtn(
            ...
            label: 'Chat',
            color: ctrl.isChatOpen.value ? Colors.blue : Colors.white70,
          ...
          _CtrlBtn(
            ...
            label: 'Raise',
            color: ctrl.isHandRaised.value ? Colors.yellow : Colors.white70,
  ...
  void _confirmEnd(BuildContext context, MeetingRoomController ctrl) {
    Get.defaultDialog(
      title: 'Leave Meeting',
      content: Text(
        'Do you want to leave or end the meeting for everyone?',
        ...
        Padding(
          ...
          child: Row(
            children: [
              Obx(
                () => Text(
                  'Participants (${ctrl.participants.length})',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 16.sp,
                    fontWeight: FontWeight.w700,
