...
/// Auto-generated unique themed wrapper for Category Docs.
/// Adds a fresh design + new content sections while preserving original content
/// (the original CategoryDocsView is embedded below the new sections).
///
/// Theme: Indigo Night | Layout: burst
class CategoryDocsEnhancedView extends StatelessWidget {
  const CategoryDocsEnhancedView({Key? key}) : super(key: key);
            ...
            child: Container(
              ...
              child: _Section(
                ...
                child: Column(children: [
                  _Pillar(n: 1, text: 'Roots before branches', accent: _accent, gold: _gold),
                  _Pillar(n: 2, text: 'Direction before speed', accent: _accent, gold: _gold),
                  _Pillar(n: 3, text: 'Character before applause', accent: _accent, gold: _gold),
                  _Pillar(n: 4, text: 'Service before self', accent: _accent, gold: _gold),
                ]),
              ),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                title: 'Action Steps',
                child: Column(children: [
                  _Step(n: 1, text: 'Pick one habit to refine', accent: _accent, gold: _gold),
                  _Step(n: 2, text: 'Reduce its friction by half', accent: _accent, gold: _gold),
                  _Step(n: 3, text: 'Practice for seven days', accent: _accent, gold: _gold),
                  _Step(n: 4, text: 'Reflect on the seventh evening', accent: _accent, gold: _gold),
                ]),
              ),
            ),
          ),
