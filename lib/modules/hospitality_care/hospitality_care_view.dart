...
class HospitalityCareView extends GetView<HospitalityCareController> {
        ...
        child: SafeArea(
          child: ListView(
            ...
            children: [
              ...
              ..._hospitalitySections.map((s) => _buildSection(context, s, isDark, onSurface)),
            ],
          ),
        ),
      ),
  ...
  Widget _buildHeader(BuildContext context, bool isDark, Color onSurface) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [Colors.teal.withOpacity(0.15), Colors.cyan.withOpacity(0.05)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
  ...
  Widget _buildSection(BuildContext context, _HospitalitySection section, bool isDark, Color onSurface) {
    final theme = Theme.of(context);
    return Container(
...
class _HospitalitySection {
  ...
  const _HospitalitySection({required this.title, required this.icon, required this.color, required this.points});
}
