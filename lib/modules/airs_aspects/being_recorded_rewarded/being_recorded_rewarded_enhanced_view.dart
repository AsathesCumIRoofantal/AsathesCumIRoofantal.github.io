...
class BeingRecordedRewardedEnhancedView extends StatelessWidget {
  const BeingRecordedRewardedEnhancedView({Key? key}) : super(key: key);
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Being Recorded Rewarded',
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Magenta Pulse', layout: 'grid',
                ...
                icon: Icons.explore_outlined, title: 'Being Recorded Rewarded'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
