...
class IdentitiesEarningsEnhancedView extends StatelessWidget {
  const IdentitiesEarningsEnhancedView({Key? key}) : super(key: key);
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Identities Earnings',
                style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.w800, color: Colors.white)),
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Slate Steel', layout: 'burst',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.flare_outlined, title: 'Identities Earnings'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
