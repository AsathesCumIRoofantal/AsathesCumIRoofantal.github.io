      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Spirituality Lord Shiva',
                style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.w800, color: Colors.white)),
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Twilight Lilac', layout: 'blocks',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.palette_outlined, title: 'Spirituality Lord Shiva'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
