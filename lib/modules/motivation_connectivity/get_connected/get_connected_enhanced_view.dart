...
class GetConnectedEnhancedView extends StatelessWidget {
  const GetConnectedEnhancedView({Key? key}) : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Crimson Vault', layout: 'circles',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.emoji_objects_outlined, title: 'Get Connected'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
