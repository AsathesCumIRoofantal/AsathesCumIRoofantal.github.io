...
class CommunicationEnhancedView extends StatelessWidget {
  const CommunicationEnhancedView({Key? key}) : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Slate Steel', layout: 'rings',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.self_improvement_outlined, title: 'Communication'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
