...
class DemonstrationEnhancedView extends StatelessWidget {
  const DemonstrationEnhancedView({Key? key}) : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Mint Spring', layout: 'grid',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.emoji_objects_outlined, title: 'Demonstration'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
