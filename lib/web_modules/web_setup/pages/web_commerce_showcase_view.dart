...
class WebCommerceShowcaseView extends StatelessWidget {
  const WebCommerceShowcaseView({super.key});

  static const routeName = '/commerce-showcase';
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Live analytics, smart inventory layers, AI commerce dashboards.',
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 18,
                              height: 1.5,
