...
/// Auto-generated unique themed wrapper for Identity.
/// Adds a fresh design + new content sections while preserving original content
/// (the original IdentityView is embedded below the new sections).
///
/// Theme: Crimson Vault | Layout: wave
class IdentityEnhancedView extends StatelessWidget {
  const IdentityEnhancedView({Key? key}) : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Crimson Vault', layout: 'wave',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.self_improvement_outlined, title: 'Identity'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
            ...
            child: Container(
              ...
              child: _Section(
                ...
                child: Column(children: [
                  _Pillar(n: 1, text: 'Begin in stillness', accent: _accent, gold: _gold),
                  _Pillar(n: 2, text: 'Choose presence over pressure', accent: _accent, gold: _gold),
                  _Pillar(n: 3, text: 'Honour the small wins', accent: _accent, gold: _gold),
                  _Pillar(n: 4, text: 'Return often, gently', accent: _accent, gold: _gold),
                ]),
              ),
            ),
          ),
