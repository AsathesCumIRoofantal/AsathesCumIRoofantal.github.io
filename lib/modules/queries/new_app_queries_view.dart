...
class NewAppQueriesView extends GetView<NewAppQueriesController> {
  const NewAppQueriesView({super.key});

  static const Color _c1 = Color(0xFF006064);
  static const Color _c2 = Color(0xFF26C6DA);
