    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Obx(
            () => TextButton(
              onPressed: ctrl.isEditing.value
                  ? ctrl.saveProfile
                  : ctrl.toggleEdit,
              child: ctrl.isSaving.value
                  ...
                  : Text(
                      ctrl.isEditing.value ? 'Save' : 'Edit',
                      style: TextStyle(
                        fontSize: 15.sp,
        ...
        return ListView(
          ...
          children: [
            ...
            _InfoSection('Account', [
              ...
              _InfoField(
                label: 'Role',
                value: user.userRoleTitle ?? 'Member',
