...
import '../widgets/enhanced_view_wrapper.dart';
...
class AppPages {
  static Widget _wrapEnhancedView(Widget page) =>
      EnhancedViewWrapper(child: page);
  ...
  static final pages = [
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const LoginEnhancedView()),
      binding: LoginBinding(),
    ),
    GetPage(
      name: AppRoutes.SIGNUP,
      page: () => _wrapEnhancedView(const SignupEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const SettingsEnhancedView()),
      binding: SettingsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.LEARN_FUN,
      page: () => _wrapEnhancedView(const LearnFunEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const QueriesEnhancedView()),
      binding: QueriesBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.WISDOM,
      page: () => _wrapEnhancedView(const WisdomEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const ShareExperienceEnhancedView()),
      binding: ShareExperienceBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.RECORD_POST,
      page: () => _wrapEnhancedView(const RecordPostEnhancedView()),
      binding: RecordPostBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.IDENTITIES_EARNINGS,
      page: () => _wrapEnhancedView(const IdentitiesEarningsEnhancedView()),
      binding: IdentitiesEarningsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.KNOWLEDGE_CENTER,
      page: () => _wrapEnhancedView(const KnowledgeCenterEnhancedView()),
      binding: KnowledgeCenterBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.PRODUCTS_SERVICES,
      page: () => _wrapEnhancedView(const ProductsServicesEnhancedView()),
      binding: ProductsServicesBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.QUERY_DISCUSSION,
      page: () => _wrapEnhancedView(const QueryDiscussionEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const EventsEnhancedView()),
      binding: EventsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.MANAGEMENTS,
      page: () => _wrapEnhancedView(const ManagementsEnhancedView()),
      binding: ManagementsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.MAINTENANCE,
      page: () => _wrapEnhancedView(const MaintenanceEnhancedView()),
      binding: MaintenanceBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.CONNECT_COLLABORATE,
      page: () => _wrapEnhancedView(const ConnectCollaborateEnhancedView()),
      binding: ConnectCollaborateBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.NOTICES,
      page: () => _wrapEnhancedView(const NoticesEnhancedView()),
      binding: NoticesBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.TRACKS_TRACES,
      page: () => _wrapEnhancedView(const TracksTracesEnhancedView()),
      binding: TracksTracesBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.YOUR_BUSINESS,
      page: () => _wrapEnhancedView(const YourBusinessEnhancedView()),
      binding: YourBusinessBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.REWARDS_CREDITS,
      page: () => _wrapEnhancedView(const RewardsCreditsEnhancedView()),
      binding: RewardsCreditsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.APPROVAL_APPEALS,
      page: () => _wrapEnhancedView(const ApprovalAppealsEnhancedView()),
      binding: ApprovalAppealsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.NETWORK_APIS,
      page: () => _wrapEnhancedView(const NetworkApisEnhancedView()),
      binding: NetworkApisBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.PRIVATE_CONFIDENTIAL,
      page: () => _wrapEnhancedView(const PrivateConfidentialEnhancedView()),
      binding: PrivateConfidentialBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.PUBLIC_STUFF,
      page: () => _wrapEnhancedView(const PublicStuffEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const InputInProcessEnhancedView()),
      binding: InputInProcessBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.PROCESS,
      page: () => _wrapEnhancedView(const ProcessEnhancedView()),
      binding: ProcessBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.OUTCOME_PROCESSED,
      page: () => _wrapEnhancedView(const OutcomeProcessedEnhancedView()),
      binding: OutcomeProcessedBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.SYSTEM_ALL_TOGETHER,
      page: () => _wrapEnhancedView(const SystemAllTogetherEnhancedView()),
      binding: SystemAllTogetherBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.REVISE_IMPROVE,
      page: () => _wrapEnhancedView(const ReviseImproveEnhancedView()),
      binding: ReviseImproveBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.PRACTICE_EXPERTISE,
      page: () => _wrapEnhancedView(const PracticeExpertiseEnhancedView()),
      binding: PracticeExpertiseBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.SHARE_CARE,
      page: () => _wrapEnhancedView(const ShareCareEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const AirsMissionEnhancedView()),
      binding: AirsMissionBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.AIRS_SHOWCASE,
      page: () => _wrapEnhancedView(const AirsShowcaseEnhancedView()),
      binding: AirsShowcaseBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.WINDUP_ELSE,
      page: () => _wrapEnhancedView(const WindupElseEnhancedView()),
      binding: WindupElseBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.FOLLOW_CALENDAR,
      page: () => _wrapEnhancedView(const FollowCalendarEnhancedView()),
      binding: FollowCalendarBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.PICK_GOOD_GOING,
      page: () => _wrapEnhancedView(const PickGoodGoingEnhancedView()),
      binding: PickGoodGoingBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.FINALLY_BLESSINGS,
      page: () => _wrapEnhancedView(const FinallyBlessingsEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const MotivationEnhancedView()),
      binding: MotivationBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.NEVER_GIVE_UP,
      page: () => _wrapEnhancedView(const NeverGiveUpEnhancedView()),
      binding: NeverGiveUpBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.INNOVATION_KEY,
      page: () => _wrapEnhancedView(const InnovationKeyEnhancedView()),
      binding: InnovationKeyBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.ACCOUNTABLE,
      page: () => _wrapEnhancedView(const AccountableEnhancedView()),
      binding: AccountableBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.LIVE_FULLEST,
      page: () => _wrapEnhancedView(const LiveFullestEnhancedView()),
      binding: LiveFullestBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.GET_CONNECTED_SOCIAL,
      page: () => _wrapEnhancedView(const GetConnectedEnhancedView()),
      binding: GetConnectedBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.TOGETHER_UNISON,
      page: () => _wrapEnhancedView(const TogetherUnisonEnhancedView()),
      binding: TogetherUnisonBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.ONBOARD,
      page: () => _wrapEnhancedView(const OnboardEnhancedView()),
      binding: OnboardBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.GREETINGS,
      page: () => _wrapEnhancedView(const GreetingsEnhancedView()),
      binding: GreetingsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.RESPONSIBILITIES,
      page: () => _wrapEnhancedView(const ResponsibilitiesEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const UtilitiesGuestEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const DigitalizeRecordsEnhancedView()),
      binding: DigitalizeRecordsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.projects_assessments,
      page: () => _wrapEnhancedView(const ProjectsAssessmentsEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const EaseToolsEnhancedView()),
      binding: EaseToolsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.vocabulary,
      page: () => _wrapEnhancedView(const VocabularyEnhancedView()),
      binding: VocabularyBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.script_strategy,
      page: () => _wrapEnhancedView(const ScriptStrategyEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const SafetyEnhancedView()),
      binding: SafetyBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.OBLIGATIONS,
      page: () => _wrapEnhancedView(const ObligationsEnhancedView()),
      binding: ObligationsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.HOSPITALITY_CARE,
      page: () => _wrapEnhancedView(const HospitalityCareEnhancedView()),
      binding: HospitalityCareBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.UTILITY_FACILITIES,
      page: () => _wrapEnhancedView(const UtilityFacilitiesEnhancedView()),
      binding: UtilityFacilitiesBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.COMMERCE,
      page: () => _wrapEnhancedView(const CommerceEnhancedView()),
      binding: CommerceBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.SOCIAL,
      page: () => _wrapEnhancedView(const SocialEnhancedView()),
      binding: SocialBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.RESEARCH_DEVELOPMENT,
      page: () => _wrapEnhancedView(const ResearchDevelopmentEnhancedView()),
      binding: ResearchDevelopmentBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.TRAVEL_TRANSPORT,
      page: () => _wrapEnhancedView(const TravelTransportEnhancedView()),
      binding: TravelTransportBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.LOOP_HOLE,
      page: () => _wrapEnhancedView(const LoopHoleEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const SolutionEnhancedView()),
      binding: SolutionBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.INNOVATION,
      page: () => _wrapEnhancedView(const InnovationEnhancedView()),
      binding: InnovationBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.DISCOVERY,
      page: () => _wrapEnhancedView(const DiscoveryEnhancedView()),
      binding: DiscoveryBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.ENHANCEMENT,
      page: () => _wrapEnhancedView(const EnhancementEnhancedView()),
      binding: EnhancementBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.HOPE,
      page: () => _wrapEnhancedView(const HopeEnhancedView()),
      binding: HopeBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.SUCCESS_FAILURE,
      page: () => _wrapEnhancedView(const SuccessFailureEnhancedView()),
      binding: SuccessFailureBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.RELIGION_PRAYER,
      page: () => _wrapEnhancedView(const ReligionPrayerEnhancedView()),
      binding: ReligionPrayerBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.FEEDBACK,
      page: () => _wrapEnhancedView(const FeedbackEnhancedView()),
      binding: FeedbackBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.HEIGHER_STUDIES,
      page: () => _wrapEnhancedView(const HeigherStudiesEnhancedView()),
      binding: HeigherStudiesBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.DOCTORATE,
      page: () => _wrapEnhancedView(const DoctorateEnhancedView()),
      binding: DoctorateBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.LIFE_HACKS,
      page: () => _wrapEnhancedView(const LifeHacksEnhancedView()),
      binding: LifeHacksBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.serve,
      page: () => _wrapEnhancedView(const ServeEnhancedView()),
      binding: ServeBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.marketing_promotion,
      page: () => _wrapEnhancedView(const MarketingPromotionEnhancedView()),
      binding: MarketingPromotionBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.RELATIONSHIPS,
      page: () => _wrapEnhancedView(const RelationshipsEnhancedView()),
      binding: RelationshipsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.PUNCTUALITY,
      page: () => _wrapEnhancedView(const PunctualityEnhancedView()),
      binding: PunctualityBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.LOYALTY,
      page: () => _wrapEnhancedView(const LoyaltyEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const EmpathySympathyEnhancedView()),
      binding: EmpathySympathyBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.FORGIVNESS,
      page: () => _wrapEnhancedView(const ForgivnessEnhancedView()),
      binding: ForgivnessBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.KINDNESS,
      page: () => _wrapEnhancedView(const KindnessEnhancedView()),
      binding: KindnessBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.RESPECT,
      page: () => _wrapEnhancedView(const RespectEnhancedView()),
      binding: RespectBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.SELF_DISCIPLINE,
      page: () => _wrapEnhancedView(const SelfDisciplineEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const FamilyEnhancedView()),
      binding: FamilyBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.FRIENDSHIP,
      page: () => _wrapEnhancedView(const FriendshipEnhancedView()),
      binding: FriendshipBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.RIVALRY,
      page: () => _wrapEnhancedView(const RivalryEnhancedView()),
      binding: RivalryBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.COMPITITION,
      page: () => _wrapEnhancedView(const CompititionEnhancedView()),
      binding: CompititionBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.TECHNOLOGY,
      page: () => _wrapEnhancedView(const TechnologyEnhancedView()),
      binding: TechnologyBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.LANGUAGE_TRANSLATION,
      page: () => _wrapEnhancedView(const LanguageTranslationEnhancedView()),
      binding: LanguageTranslationBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.MONITORSHIP,
      page: () => _wrapEnhancedView(const MonitorshipEnhancedView()),
    ...
    GetPage(
      ...
      page: () =>
          _wrapEnhancedView(const SurvellenceInvestigationEnhancedView()),
      binding: SurvellenceInvestigationBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.LEADERSHIP,
      page: () => _wrapEnhancedView(const LeadershipEnhancedView()),
      binding: LeadershipBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.CONTROL_COORDINATION,
      page: () => _wrapEnhancedView(const ControlCoordinationEnhancedView()),
    ...
    GetPage(
      ...
      page: () => _wrapEnhancedView(const TradeImportExportEnhancedView()),
      binding: TradeImportExportBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.RANKING_ORDERS,
      page: () => _wrapEnhancedView(const RankingOrdersEnhancedView()),
      binding: RankingOrdersBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.STATISTICS,
      page: () => _wrapEnhancedView(const StatisticsEnhancedView()),
      binding: StatisticsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.PEACE_PROSPERITY,
      page: () => _wrapEnhancedView(const PeaceProsperityEnhancedView()),
      binding: PeaceProsperityBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.WORLD,
      page: () => _wrapEnhancedView(const WorldEnhancedView()),
      binding: WorldBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.UNIVERSAL_PEACE_RULE,
      page: () => _wrapEnhancedView(const UniversalPeaceRuleEnhancedView()),
      binding: UniversalPeaceRuleBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.KEEP_ADDING_WITH_PATIENCE,
      page: () => _wrapEnhancedView(const KeepAddingWithPatienceEnhancedView()),
      binding: KeepAddingWithPatienceBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.MEDIA_NEWS,
      page: () => _wrapEnhancedView(const MediaNewsEnhancedView()),
      binding: MediaNewsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.ENGAGEMENTS,
      page: () => _wrapEnhancedView(const EngagementsEnhancedView()),
      binding: EngagementsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.DEMONSTRATION,
      page: () => _wrapEnhancedView(const DemonstrationEnhancedView()),
      binding: DemonstrationBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.GROUP_DISCUSSIONS,
      page: () => _wrapEnhancedView(const GroupDiscussionsEnhancedView()),
      binding: GroupDiscussionsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.SITUATION_REACTION,
      page: () => _wrapEnhancedView(const SituationReactionEnhancedView()),
      binding: SituationReactionBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.GROUND_TASK,
      page: () => _wrapEnhancedView(const GroundTaskEnhancedView()),
      binding: GroundTaskBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.INTERVIEWS,
      page: () => _wrapEnhancedView(const InterviewsEnhancedView()),
      binding: InterviewsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.MERITS_DEMERITS,
      page: () => _wrapEnhancedView(const MeritsDemeritsEnhancedView()),
      binding: MeritsDemeritsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.MEDICAL,
      page: () => _wrapEnhancedView(const MedicalEnhancedView()),
      binding: MedicalBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.JOINING_SERVICES,
      page: () => _wrapEnhancedView(const JoiningServicesEnhancedView()),
      binding: JoiningServicesBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.RULES_REGULATIONS,
      page: () => _wrapEnhancedView(const RulesRegulationsEnhancedView()),
      binding: RulesRegulationsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.COURT_CASES,
      page: () => _wrapEnhancedView(const CourtCasesEnhancedView()),
      binding: CourtCasesBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.ELECTIONS,
      page: () => _wrapEnhancedView(const ElectionsEnhancedView()),
      binding: ElectionsBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.HEART_WINNING,
      page: () => _wrapEnhancedView(const HeartWinningEnhancedView()),
      binding: HeartWinningBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.SPIRITUALITY_LORD_SHIVA,
      page: () => _wrapEnhancedView(const SpiritualityLordShivaEnhancedView()),
      binding: SpiritualityLordShivaBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.PRAYER_FOR_ALL,
      page: () => _wrapEnhancedView(const PrayerForAllEnhancedView()),
      binding: PrayerForAllBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.FINGERS_ARE_CROSSED,
      page: () => _wrapEnhancedView(const FingersAreCrossedEnhancedView()),
      binding: FingersAreCrossedBinding(),
      transition: Transition.rightToLeft,
    ),
    GetPage(
      name: AppRoutes.COUNTING_REPORTS,
      page: () => _wrapEnhancedView(const CountingReportsEnhancedView()),
