      ...
      child: Row(
        children: [
          ...
          Obx(() {
            ...
            return Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                const Icon(Icons.fiber_manual_record, color: _Z.green, size: 8),
                const SizedBox(width: 4),
                Text(controller.formattedDuration,
                    style: const TextStyle(
                        color: _Z.green, fontSize: 11,
                        fontWeight: FontWeight.w700)),
              ]),
            );
          }),
          ...
          Obx(() => AnimatedContainer(
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              Icon(Icons.psychology_rounded,
                  color: controller.isAiTranscribing.value
                      ? _Z.purple : _Z.textSecondary,
                  size: 13),
              const SizedBox(width: 4),
              Text(
                controller.isAiTranscribing.value
                    ? 'AI Live Captions' : 'AI Idle',
                style: TextStyle(
                    color: controller.isAiTranscribing.value
                        ? _Z.purple : _Z.textSecondary,
          ...
          Obx(() => Container(
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              const Icon(Icons.group_rounded,
                  color: _Z.textSecondary, size: 13),
              const SizedBox(width: 4),
              Text('${controller.participantCount}',
                  style: const TextStyle(
                      color: _Z.textSecondary, fontSize: 11,
          ...
          Obx(() => _TinyButton(
            ...
            label: controller.viewMode.value == 'gallery' ? 'Speaker' : 'Gallery',
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: _Z.surfaceHigh, borderRadius: BorderRadius.circular(8)),
        child: Row(mainAxisSize: MainAxisSize.min, children: [
              ...
              children: [
                ...
                if (muted_)
                  Positioned.fill(
                    child: IgnorePointer(
                      child: Container(
                          color: _Z.red.withValues(alpha: 0.06)),
                    ),
                  ),
                ...
                Positioned(
                  top: 8, left: 8,
                  child: _NameTag(
                      name: name, muted: muted_, isPinned: isPinned_),
                ),
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
            colors: [grad[0].withValues(alpha: 0.25),
...
class _NameTag extends StatelessWidget {
  ...
  final bool   isPinned;
  const _NameTag(
      {required this.name, required this.muted, required this.isPinned});
      ...
      child: Obx(() => Row(
        ...
        children: [
          ...
          _CtrlBtn(
            ...
            label: controller.isVideoDisabled.value ? 'Start Video' : 'Stop Video',
          ...
          _CtrlBtn(
            ...
            label: controller.isScreenSharing.value ? 'Stop Share' : 'Share Screen',
          ...
          _CtrlBtn(
            ...
            label: controller.isHandRaised.value ? 'Lower Hand' : 'Raise Hand',
          ...
          child: Obx(() {
            ...
            return ListView.separated(
              ...
              itemBuilder: (_, i) {
                final uid  = uids[i];
                final isMe = uid == 0;
                final name = controller.participantNames[uid] ?? 'Participant $uid';
                final muted = isMe
                      ...
                      children: [
                        ...
                        Row(children: [
                          if (speaking)
                            ...
                            Text(isMe ? 'Host (You)' : 'Participant',
                                style: const TextStyle(
                                    color: _Z.textSecondary, fontSize: 11)),
                        ]),
                      ],
      ...
      child: Row(children: [
        ...
        GestureDetector(
          ...
          child: const Icon(Icons.close_rounded,
              color: _Z.textSecondary, size: 18),
        ),
      ]),
    );
  }
