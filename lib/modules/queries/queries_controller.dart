  ...
  void _loadInitialMockQueries() {
    allQueries.assignAll([
      QueryModel(
        ...
        description:
            'I noticed some entities have higher classifications. Is this related to my Get-As-Identified phase?',
      ...
      QueryModel(
        ...
        description:
            'Searching for documentation regarding the consciousness entropy mappings. Could you guide me?',
  ...
  void _applyFilters() {
    ...
    if (searchQuery.value.isNotEmpty) {
      ...
      temp = temp
          .where(
            (q) =>
                q.subject.toLowerCase().contains(s) ||
  ...
  void submitQuery() {
    ...
    allQueries.add(
      QueryModel(
        ...
        attachedFiles: [
          'Mock_Attachment.pdf',
        ], // We always pretend there's an attachment for the UX
      ),
    );
    ...
    Get.snackbar(
      'Query Submitted',
      'Your request has been filed with the Wisdom Engine.',
