...
class InputInProcessEnhancedView extends StatelessWidget {
  const InputInProcessEnhancedView({Key? key}) : super(key: key);
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Input In Process',
                style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.w800, color: Colors.white)),
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Olive Grove', layout: 'stripes',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.psychology_outlined, title: 'Input In Process'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
