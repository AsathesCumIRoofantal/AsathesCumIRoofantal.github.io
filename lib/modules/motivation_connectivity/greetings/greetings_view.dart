...
class GreetingsView extends GetView<GreetingsController> {
  ...
  Widget _buildHeroHeader(BuildContext context, bool isDark, Color onSurface) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _warm.withValues(alpha: 0.38)),
        boxShadow: [
          BoxShadow(color: _warm.withValues(alpha: 0.12), blurRadius: 16),
        ],
      ),
      child: Row(
        children: [
          ...
          .map(
            (c) => Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: _warm.withValues(alpha: 0.22)),
              ),
              child: Row(
          ...
          .map(
            (c) => Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: c.$3.withValues(alpha: 0.20)),
              ),
              child: Row(
                children: [
  ...
  Widget _buildGreetingPrinciple(
    BuildContext context,
    bool isDark,
    Color onSurface,
  ) {
