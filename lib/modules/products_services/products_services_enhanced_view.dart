...
class ProductsServicesEnhancedView extends StatelessWidget {
  const ProductsServicesEnhancedView({Key? key}) : super(key: key);
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Neon Iris', layout: 'rings',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.emoji_objects_outlined, title: 'Products Services'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
