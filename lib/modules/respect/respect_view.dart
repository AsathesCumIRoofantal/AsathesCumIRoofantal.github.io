    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFF2D1A00), const Color(0xFF160C00)],
        ...
        boxShadow: [
          BoxShadow(color: _gold.withValues(alpha: 0.10), blurRadius: 16),
        ],
      ),
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Respect in AIR is about establishing clear baselines — how you address people, honour their boundaries, and protect their dignity by default. It\'s not earned once; it\'s practised consistently.',
                  style: TextStyle(
                    fontSize: 12,
                    height: 1.4,
