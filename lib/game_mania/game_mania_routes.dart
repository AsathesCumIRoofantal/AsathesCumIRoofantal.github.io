...
abstract class GameManiaRoutes {
  ...
  static final pages = <GetPage>[
    GetPage(name: home,         page: () => const GameManiaHome(),  transition: Transition.fadeIn),
    GetPage(name: spaceShooter, page: () => const SpaceShooterEntry(), transition: Transition.fadeIn),
    GetPage(name: snake,        page: () => const SnakeEntry(),     transition: Transition.fadeIn),
