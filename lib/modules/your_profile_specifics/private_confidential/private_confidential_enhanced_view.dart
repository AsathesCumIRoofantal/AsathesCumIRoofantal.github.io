...
class PrivateConfidentialEnhancedView extends StatelessWidget {
  const PrivateConfidentialEnhancedView({Key? key}) : super(key: key);
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Private Confidential',
                style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.w800, color: Colors.white)),
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Indigo Night', layout: 'circles',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.temple_hindu_outlined, title: 'Private Confidential'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
