...
class SituationReactionEnhancedView extends StatelessWidget {
  const SituationReactionEnhancedView({Key? key}) : super(key: key);
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Situation Reaction',
                style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.w800, color: Colors.white)),
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Cyber Lime', layout: 'rings',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.local_fire_department_outlined, title: 'Situation Reaction'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
