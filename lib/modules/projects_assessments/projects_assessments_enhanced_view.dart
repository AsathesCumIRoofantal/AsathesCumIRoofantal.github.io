...
class ProjectsAssessmentsEnhancedView extends StatelessWidget {
  const ProjectsAssessmentsEnhancedView({Key? key}) : super(key: key);
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Projects Assessments',
                style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.w800, color: Colors.white)),
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Twilight Lilac', layout: 'burst',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.timeline_outlined, title: 'Projects Assessments'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
