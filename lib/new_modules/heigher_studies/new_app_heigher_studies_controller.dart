...
class NewAppHeigherStudiesController extends GetxController {
  final String title = "Higher Studies";
  final String tagline = "Structured orientation into formal study lanes.";
