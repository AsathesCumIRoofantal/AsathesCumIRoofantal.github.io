    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFF111827), const Color(0xFF060A10)],
        ...
        boxShadow: [
          BoxShadow(color: _orange.withValues(alpha: 0.10), blurRadius: 16),
        ],
      ),
      child: Column(
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Self-discipline in AIR is a systems problem, not a willpower problem. Design habits, track streaks, and build consequence structures that make the right behaviour the path of least resistance.',
                      style: TextStyle(
                        fontSize: 12,
                        height: 1.4,
  ...
  Widget _buildStreakPanel(BuildContext context, bool isDark, Color onSurface) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _orange.withValues(alpha: 0.14)),
      ),
      child: Column(
        children: habits
            .map(
                        ...
                        FractionallySizedBox(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: h.$4.withValues(alpha: 0.30),
                                  blurRadius: 4,
                                ),
                              ],
                            ),
