    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            _blue.withValues(alpha: isDark ? 0.20 : 0.12),
            _violet.withValues(alpha: isDark ? 0.15 : 0.08),
          ],
      ...
      child: Column(
        ...
        children: [
          Icon(
            Icons.format_quote_rounded,
            size: 48,
            color: _blue.withValues(alpha: 0.80),
          ),
          ...
          OutlinedButton.icon(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: BorderSide(color: _blue.withValues(alpha: 0.50)),
  ...
  Widget _buildPracticeCard(BuildContext context, bool isDark, _Practice p) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: p.color.withValues(alpha: 0.20)),
      ),
      child: Row(
        children: [
          Container(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(
            Icons.format_quote_rounded,
            color: _sky.withValues(alpha: 0.60),
            size: 28,
          ),
...
final _dailyPractices = [
  _Practice(
    ...
    'Write one clear intention for the day before checking any device. It anchors your energy before the world claims it.',
    '5 min',
    Icons.wb_sunny_rounded,
    Color(0xFF2563EB),
  ),
  _Practice(
    'Gratitude Snapshot',
    'Name three specific things — not generic ones — that you are genuinely grateful for today. Specificity builds the neural pattern.',
    '3 min',
  ...
  _Practice(
    'Progress Review',
    'At day\'s end, record one thing you moved forward today — however small. Progress, not perfection, sustains motivation.',
    '5 min',
  ...
  _Practice(
    ...
    'Rate your energy source today: Was it fear-based or aspiration-based? Aspiration-based motivation is sustainable; fear-based burns out.',
    '2 min',
    Icons.bolt_rounded,
    Color(0xFF7C3AED),
  ),
...
final _scienceFacts = [
  _ScienceFact(
    'The 2-Minute Rule',
    'If a task takes less than two minutes, do it immediately. This removes the decision-debt that drains motivational energy throughout the day.',
    Icons.timer_rounded,
  ),
  _ScienceFact(
    'Implementation Intentions',
    'Stating "I will do X at time Y in location Z" makes goal achievement 2-3x more likely than stating the goal alone — per Gollwitzer\'s research.',
    Icons.calendar_today_rounded,
  ),
  _ScienceFact(
    'Dopamine & Process',
    'Dopamine spikes not just on achievement but on anticipated progress. Breaking goals into visible sub-steps delivers motivational fuel more consistently.',
    Icons.science_rounded,
  ),
  _ScienceFact(
    'Intrinsic vs. Extrinsic',
    'Intrinsic motivation — doing something for its inherent value — produces longer-lasting, higher-quality effort than extrinsic rewards alone.',
