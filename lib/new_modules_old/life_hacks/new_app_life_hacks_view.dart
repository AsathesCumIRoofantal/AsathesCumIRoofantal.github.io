...
/// Life Hacks — alifiyas (beginner) lane.
/// Common requisites first, then role-shaped specifics.
class NewAppLifeHacksView extends GetView<NewAppLifeHacksController> {
  const NewAppLifeHacksView({super.key});

  static const Color _c1 = Color(0xFFBF360C);
  static const Color _c2 = Color(0xFFFF7043);
