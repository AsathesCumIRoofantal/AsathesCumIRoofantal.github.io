    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          ..._sources.map(
            (s) => _buildSourceRow(context, isDark, onSurface, s),
          ),
          const SizedBox(height: 24),
          _buildSectionLabel(
            'INPUT CAPABILITIES',
  ...
  Widget _buildHeroHeader(BuildContext context, bool isDark, Color onSurface) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _electric.withValues(alpha: 0.40)),
        boxShadow: [
          BoxShadow(
            color: _electric.withValues(alpha: 0.15),
            blurRadius: 18,
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Track and validate everything that enters the AIR pipeline before any transformation begins — capturing inputs accurately at the source prevents errors compounding downstream.',
                      style: TextStyle(
                        fontSize: 12,
                        height: 1.4,
  ...
  Widget _buildFunnelVisualizer(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _electric.withValues(alpha: 0.15)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                    ...
                    children: [
                      ...
                      FractionallySizedBox(
                        ...
                        child: Container(
                          height: 6,
                          decoration: BoxDecoration(
                            color: s.$4.withValues(alpha: 0.80),
                            borderRadius: BorderRadius.circular(3),
                            boxShadow: [
                              BoxShadow(
  ...
  Widget _buildStatusBanner(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            _electric.withValues(alpha: 0.10),
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: _electric.withValues(alpha: 0.20)),
      ),
      child: Row(
        children: [
