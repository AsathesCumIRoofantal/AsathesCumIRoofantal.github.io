...
/// Auto-generated unique themed wrapper for Category Tree.
/// Adds a fresh design + new content sections while preserving original content
/// (the original CategoryTreeView is embedded below the new sections).
///
/// Theme: Ocean Deep | Layout: rings
class CategoryTreeEnhancedView extends StatelessWidget {
  const CategoryTreeEnhancedView({Key? key}) : super(key: key);
            ...
            child: Container(
              ...
              child: _Section(
                ...
                child: Column(children: [
                  _Pillar(n: 1, text: 'Plant seeds daily', accent: _accent, gold: _gold),
                  _Pillar(n: 2, text: 'Water without expectation', accent: _accent, gold: _gold),
                  _Pillar(n: 3, text: 'Trust the season', accent: _accent, gold: _gold),
                  _Pillar(n: 4, text: 'Harvest with gratitude', accent: _accent, gold: _gold),
                ]),
              ),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
              ...
              child: _Section(
                ...
                title: 'Action Steps',
                child: Column(children: [
                  _Step(n: 1, text: 'Pause for one full breath before starting', accent: _accent, gold: _gold),
                  _Step(n: 2, text: 'Write a single intention for today', accent: _accent, gold: _gold),
                  _Step(n: 3, text: 'Take one action — however small', accent: _accent, gold: _gold),
                  _Step(n: 4, text: 'Note what shifted, however subtly', accent: _accent, gold: _gold),
                ]),
              ),
            ),
          ),
