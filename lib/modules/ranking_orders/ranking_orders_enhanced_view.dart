...
class RankingOrdersEnhancedView extends StatelessWidget {
  const RankingOrdersEnhancedView({Key? key}) : super(key: key);
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: const Text('Ranking Orders',
                style: TextStyle(letterSpacing: 2, fontWeight: FontWeight.w800, color: Colors.white)),
            flexibleSpace: FlexibleSpaceBar(
              background: _Hero(palette: 'Slate Steel', layout: 'diagonal',
                bg: _bg, bg2: _bg2, accent: _accent, soft: _soft, gold: _gold,
                icon: Icons.self_improvement_outlined, title: 'Ranking Orders'),
            ),
          ),
          SliverToBoxAdapter(
            child: Container(
