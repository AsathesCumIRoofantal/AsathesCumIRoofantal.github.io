    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color(0xFF3A1500), const Color(0xFF1C0A00)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(22),
        border: Border.all(color: _warm.withValues(alpha: 0.35)),
        boxShadow: [
          BoxShadow(color: _amber.withValues(alpha: 0.10), blurRadius: 16),
        ],
      ),
      child: Column(
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: _warm.withValues(alpha: 0.15),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Family in AIR is about being intentional with the people who matter most — defining roles, protecting rituals, and keeping shared life organised. Strong families run on clarity, not just love.',
                      style: TextStyle(
                        fontSize: 12,
                        height: 1.4,
      ...
      children: roles
          .map(
            (r) => Container(
              ...
              decoration: BoxDecoration(
                color: r.$3.withValues(alpha: 0.07),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: r.$3.withValues(alpha: 0.20)),
              ),
              child: Row(
                children: [
  ...
  Widget _buildFamilyQuote(BuildContext context, bool isDark, Color onSurface) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: _warm.withValues(alpha: 0.20)),
      ),
      child: Row(
        children: [
