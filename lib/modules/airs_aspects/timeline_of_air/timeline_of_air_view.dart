...
class TimelineOfAirView extends GetView<TimelineOfAirController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Timeline of AIR', style: TextStyle(letterSpacing: 1.5, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: ListView(
        ...
        children: [
          ...
          _buildTimelineEvent(context, isDark,
            date: '2019', era: 'GENESIS', color: _gold,
          ...
          _buildTimelineEvent(context, isDark,
            date: '2020', era: 'FRAMEWORK', color: _gold,
          ...
          _buildSectionLabel('GROWTH ERA', Icons.trending_up_rounded, _teal, context),
          _buildTimelineEvent(context, isDark,
            date: '2021', era: 'FOUNDATION', color: _teal,
            ...
            isFirst: false, isLast: false),
          _buildTimelineEvent(context, isDark,
            date: '2022', era: 'BUILD', color: _teal,
            ...
            isFirst: false, isLast: false),
          _buildTimelineEvent(context, isDark,
            date: '2023', era: 'LAUNCH', color: _teal,
            ...
            isFirst: false, isLast: false),
          _buildSectionLabel('CURRENT ERA', Icons.radio_button_checked_rounded, _indigo, context),
          _buildTimelineEvent(context, isDark,
            date: '2024', era: 'IDENTITY', color: _indigo,
            ...
            isFirst: false, isLast: false),
          _buildTimelineEvent(context, isDark,
            date: '2025', era: 'ECONOMY', color: _indigo,
            ...
            isFirst: false, isLast: false),
          _buildSectionLabel('FUTURE ROADMAP', Icons.explore_rounded, _purple, context),
          _buildTimelineEvent(context, isDark,
            date: '2026', era: 'SCALE', color: _purple,
            ...
            isFirst: false, isLast: false),
          _buildTimelineEvent(context, isDark,
            date: '2027', era: 'GOVERN', color: _green,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [_teal.withOpacity(0.18), _indigo.withOpacity(0.10)],
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                const Text('ORGANISATION HISTORY',
                    style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold,
                        letterSpacing: 2, color: _teal)),
                const SizedBox(height: 6),
                Text('Every milestone from inception to the horizon of full governance.',
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 6),
              Text(s.$1, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: s.$3)),
              Text(s.$2, style: TextStyle(fontSize: 9, color: s.$3.withOpacity(0.8), letterSpacing: 0.5)),
            ],
          ),
        ),
      )).toList(),
  ...
  Widget _buildSectionLabel(String label, IconData icon, Color color, BuildContext context) {
    return Padding(
  ...
  Widget _buildTimelineEvent(BuildContext context, bool isDark, {
    required String date, required String era, required Color color,
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isDark ? color.withOpacity(0.05) : color.withOpacity(0.04),
                borderRadius: BorderRadius.circular(16),
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Text(date, style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: color)),
                      ),
                      ...
                      Container(
                        ...
                        child: Text(era, style: TextStyle(fontSize: 9, letterSpacing: 1, color: color)),
                      ),
                    ],
                  ),
                  const SizedBox(height: 10),
                  Text(title, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: onSurface)),
                  const SizedBox(height: 8),
                  Text(description, style: TextStyle(fontSize: 13, height: 1.5, color: onSurface.withOpacity(0.72))),
                ],
              ),
            ),
          ),
  ...
  Widget _buildClosingBanner(BuildContext context, bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [_green.withOpacity(0.12), _teal.withOpacity(0.08)],
          begin: Alignment.topLeft, end: Alignment.bottomRight,
        ),
